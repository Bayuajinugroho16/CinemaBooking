                ...
                <div class="swiper-wrapper">
                    @forelse($films as $film)
                        <div class="swiper-slide">
                            <div
                                class="bg-gray-800 rounded-xl shadow-xl border border-gray-700 hover:shadow-yellow-500/20 transform transition duration-300 mx-2">
                                <!-- Badge Harga -->
                                <span
                                ...
                                <div class="p-4">
                                    ...
                                    <div class="flex items-center justify-between mt-3">
                                        <div class="flex items-center text-yellow-400">
                                            ...
                                            <span
                                                class="ml-1 text-sm font-semibold">{{ $film->duration ?? 'N/A' }}</span>
                                        </div>
                                    ...
                                    <a href="{{ route('films.book', $film->id) }}"
                                        class="mt-4 w-full block text-center bg-yellow-500 text-gray-900 px-4 py-3 text-sm font-bold rounded-lg hover:bg-yellow-400 transition">
